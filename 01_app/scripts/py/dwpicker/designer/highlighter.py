...
TEXT_STYLES = {
    "keyword": {"color": "white", "bold": True, "italic": False},
    "number": {"color": "cyan", "bold": False, "italic": False},
    "comment": {"color": (0.7, 0.5, 0.5), "bold": False, "italic": False},
    "function": {"color": "#ff0571", "bold": False, "italic": True},
    "string": {"color": "yellow", "bold": False, "italic": False},
    "boolean": {"color": "#a18852", "bold": True, "italic": False},
}
...
class Highlighter(QtGui.QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        for name, properties in TEXT_STYLES.items():
            ...
            self.rules.append((QtCore.QRegExp(self.PATTERNS[name]), text_format))
