...
from .geometry import (
    ...
    get_bottomleft_rect,
    get_topright_rect,
    get_bottomright_rect,
    get_left_side_rect,
    get_right_side_rect,
    get_top_side_rect,
    get_bottom_side_rect,
    proportional_rect,
)
...
EXCECUTION_WARNING = """Code execution failed for shape: "{name}"
{error}.
"""
...
class Manipulator:
    ...
    def handler_rects(self):
        return [
            self._tl_corner_rect,
            self._bl_corner_rect,
            self._tr_corner_rect,
            self._br_corner_rect,
            self._l_side_rect,
            self._r_side_rect,
            self._t_side_rect,
            self._b_side_rect,
...
class Shape:
    ...
    def execute(self, left=False, right=False):
        ...
        try:
            ...
            print(EXCECUTION_WARNING.format(name=self.options["text.content"], error=e))
