...
def UI(parentWindow=None, user_width=180, user_height=17, frameClosed=False):
	...
	cmds.button(l="<<", command=lambda x:scaleKeysby("cushionLeft"), width=user_width*.4, height=user_height, bgc=[.651,.286,.749], annotation="Favor to the Left! (Ctrl + Click = Match Left)")
	cmds.button(l=">>", command=lambda x:scaleKeysby("cushionRight") , width=user_width*.4, height=user_height,bgc=[.286,.615,.615], annotation="Favor to the Right! (Ctrl + Click = Match Right)")
