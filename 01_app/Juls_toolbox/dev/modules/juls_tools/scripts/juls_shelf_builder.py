...
class Builder:
    ...
    the use of these buttons is done within the "juls_anim_shelf.py" file."""

    def __init__(
        self, name=juls_shelf_info.shelf_name, icon_path=juls_shelf_info.icon_path
    ):
        self.name = name
        self.icon_path = icon_path

        self.labelBackground = (1, 0, 0.5, 1)
